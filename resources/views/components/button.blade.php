<div>
    ...
    <div style="text-align:center;">
        ...
        <a  style="background-color: {{$color}};" href="{{ $route_download }}" class="btn btn-primary btn-sm glyphicon glyphicon-cloud-download disabled" role="button" aria-disabled="true" style="color:black;"><b> {{ trans('message.botones.download') }}</b></a>
        <a  style="background-color: {{$color}};" href="{{ $route_upload }}" class="btn btn-primary btn-sm glyphicon glyphicon-cloud-upload disabled" role="button" aria-disabled="true" style="color:black;"><b> {{ trans('message.botones.upload') }}</b></a>
    </div>