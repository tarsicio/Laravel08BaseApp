    ...
    <div class="card">
        <div class="card-body">
            <div class="col-lg-12 col-xs-12">
                ...
                @endif                
                {!! Form::open(array('route' => array('rols.update',$rol->id),
                ...
                <div class="col-lg-6 col-xs-6">                    
                    ...
                    <div style="text-align:left;">
                        ...
                        {!! Form::text('description',$rol->description,['class' => 'form-control','id' => 'name_description']) !!}
                    </div>                            
                </div>        
                <hr>
                        {!! Form::submit(trans('message.rols_action.update_rols'),['class'=> 'form-control btn btn-primary','title' => trans('message.rols_action.update_rols'),'data-toggle' => 'tooltip','style' => 'background-color:'.$array_color['group_button_color'].';']) !!}                     
                </div>      
                {!!  Form::close() !!}
            </div>             
        </div>
