    ...
    <div class="card">
        <div class="card-body">
            <div class="col-lg-12 col-xs-12">
                ...
                <hr>
                        {!! Form::submit(trans('message.rols_action.update_rols'),['class'=> 'form-control btn btn-primary','title' => trans('message.rols_action.update_rols'),'data-toggle' => 'tooltip','style' => 'background-color: #5333ed']) !!}                     
                </div>      
                {!!  Form::close() !!}
            </div>             
        </div>
