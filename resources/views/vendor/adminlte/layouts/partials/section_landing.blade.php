<section id="intro" class="clearfix">
      <div class="container">
        ...
        <div style="text-align:center;"><h3>{{ trans('message.home.realizado') }}<b>Tarsicio Carrizales</b></h3></div>
        <div style="text-align:center;"><h5>{{ trans('message.home.mail') }}<b>telecom.com.ve@gmail.com</b></h5></div>        
      </div>
    </section><!-- #intro -->
