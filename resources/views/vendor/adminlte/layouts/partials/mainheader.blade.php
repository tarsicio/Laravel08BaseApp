...
<header class="main-header">
    ...
    <!-- Logo -->
    <a style="background-color: {{$encabezado_color}}" href="{{ url('/') }}" class="logo">
        <!-- mini logo for sidebar mini 50x50 pixels -->
        <span style="background-color: {{$encabezado_color}}" class="logo-mini"><b>HORUS</b></span>
        <!-- logo for regular state and mobile devices -->
        <span style="background-color: {{$encabezado_color}}" class="logo-lg"><b>{{ trans('message.home_1') }}</b></span>
    </a>

    <!-- Header Navbar -->
    <nav class="navbar navbar-static-top" role="navigation" style="background-color: {{$encabezado_color}}">
        <!-- Sidebar toggle button-->
        <a  style="background-color: {{$encabezado_color}}" href="#" class="sidebar-toggle" data-toggle="push-menu" role="button">
                ...
                @else
                    ...
                    <li class="dropdown user user-menu" id="user_menu" style="max-width: 280px;white-space: nowrap;">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header" style="background-color: {{$encabezado_color}}">
                              <!--  <img src="{{ Gravatar::get($user->email) }}" class="img-circle" alt="User Image" /> -->
                                @if (Auth::user()->avatar == 'default.jpg' || is_null(Auth::user()->avatar))
