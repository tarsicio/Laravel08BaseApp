        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown notifications-menu">
                    ...
                    <ul class="dropdown-menu">
                        <li class="header">{{ trans('adminlte_lang::message.notifications') }}{{$count_notification}}{{ trans('adminlte_lang::message.notifications_2') }}</li>
                        <li>
                            <!-- Inner Menu: contains the notifications -->
                            <ul class="menu">
                                <li><!-- start notification -->
                                    <a href="{{ url('/notifications/all') }}">
                                        <i class="fa fa-bell text-aqua"></i> {{ trans('adminlte_lang::message.notifications') }}{{$count_notification}}{{ trans('adminlte_lang::message.notifications_2') }}
                                    </a>
                                </li><!-- end notification -->
                            </ul>
                        </li>
