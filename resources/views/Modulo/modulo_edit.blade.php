    ...
    <div class="card">
        <div class="card-body">
            <div class="col-lg-12 col-xs-12">
                ...
                <hr>
                        {!! Form::submit(trans('message.modulo_action.update_modulo'),['class'=> 'form-control btn btn-primary','title' => trans('message.modulo_action.update_modulo'),'data-toggle' => 'tooltip','style' => 'background-color:'.$array_color['group_button_color'].';']) !!}                     
                </div>      
                {!!  Form::close() !!}
            </div>             
        </div>
