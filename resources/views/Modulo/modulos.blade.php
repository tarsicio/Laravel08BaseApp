...
@component('components.button',['titulo_modulo' => trans('message.menu_modulo'),
                                'router_modulo_create' => route('modulos.create'),
                                'id_new_modulo' => 'new_modulos',
                                'boton_crear' => trans('message.menu_modulo'),
                                'route_print' => route('modulos.modulosPrint'),
                                'route_download' => route('modulos.modulosPrint'),
                                'route_upload' => route('modulos.modulosPrint'),
...
<script src="{{ url (mix('/js_delete/delete_confirm.js')) }}"></script>
@endsection
